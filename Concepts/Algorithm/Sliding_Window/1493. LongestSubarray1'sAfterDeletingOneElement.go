...
// LongestSubarray https://leetcode.com/problems/longest-subarray-of-1s-after-deleting-one-element/description/?envId=leetcode-75
...
func LongestSubarrayExercise(nums []int) int {
	return 0
}
